...
b_Z(d){switch(d.am(y.k).r.f.gcz()){case"en":return D.LS
case"es":return D.LT
case"pt":default:return D.LU}},
aoZ:function aoZ(){},
aBo:function aBo(){},
aBm:function aBm(){},
aBn:function aBn(){},
...
goY(){return"Pol\xedtica de privacidade, dados pessoais, cookies e termos de uso"},
pv(d){return"\xdaltima atualiza\xe7\xe3o: documento institucional. Em caso de d\xfavida sobre tratamento de dados, contacte: "+d+"."},
...
goD(){return"Perfect Gest Dev"},
goY(){return"Privacy policy, personal data, cookies and terms of use"},
pv(d){return"Last updated: institutional document. If you have questions about data processing, contact: "+d+"."},
...
goD(){return"Perfect Gest Dev"},
goY(){return"Politica de privacidad, datos personales, cookies y terminos de uso"},
pv(d){return"Ultima actualizacion: documento institucional. Si tiene dudas sobre el tratamiento de datos, contacte: "+d+"."},
...
w=s.ry
if(w==null){w=s.n
if(w==null)w=s.k3}w=A.ie(w.aj(0.4),1)
v=r<360
u=v?15:16
u=A.Z(p,t,t,t,A.b4().$3$color$fontSize$fontWeight(s.b,u,C.aS),t,t)
v=v?13:14
return new A.bm(D.OK,A.aX(t,t,A.dt(new A.bm(new A.ae(q,16,q,18),A.bZ(A.b([u,C.d2,A.Z(this.d,t,t,t,A.b4().$3$color$fontSize$height(s.k3.aj(0.88),v,1.55),t,t)],y.e),C.X,C.x,C.B),t),new A.bN(o,t,w,x,t,t,C.S),C.aj),!0,t,t,t,!1,t,t,t,t,t,t,t,p,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,C.p,t),t)}}
var z=a.updateTypes([])
B.ayC.prototype={
...
u=a9.c
t=u.b
s=A.Z(v.goD(),b0,b0,b0,A.b4().$4$color$fontSize$fontWeight$letterSpacing(t,13,C.aS,0.4),b0,b0)
r=v.goY()
q=a9.d
p=q<400
o=p?18:22
n=u.k3
o=A.Z(r,b0,b0,b0,A.b4().$4$color$fontSize$fontWeight$height(n,o,C.b1,1.2),b0,b0)
r=A.Z(v.pv(b1),b0,b0,b0,A.b4().$3$color$fontSize$height(n.aj(0.72),13,1.45),b0,b0)
m=v.gnR()
l=v.gnQ()
k=v.gnT()
j=v.gnS()
...
a7=a9.e
a8=y.e
return A.iI(A.dY(new A.dn(new A.aa(0,x,0,1/0),A.bZ(A.b([s,C.el,o,C.d2,r,C.hL,new B.kU(m,l,b0),new B.kU(k,j,b0),new B.kU(i,h,b0),new B.kU(g,f,b0),new B.kU(e,d,b0),new B.kU(a0,a1,b0),new B.kU(a2,a3,b0),C.fl,A.dt(new A.bm(new A.ae(p,p,p,p),A.bZ(A.b([a5,C.bQ,a6,C.cE,A.iQ(C.bz,A.b([A.ac2(D.Qo,A.Z(q<360?v.gJp():v.gJo(),b0,b0,b0,b0,C.dE,b0),new B.ayA(b3,v),b0),new A.C_(!1,new B.ayB(b3,a7),b0,b0,b0,b0,b0,b0,!1,b0,!0,b0,A.Z(a7.gvA(),b0,b0,b0,b0,b0,b0),b0)],a8),C.cI,8,8)],a8),C.bh,C.x,C.B),b0),new A.bN(t,b0,u,a4,b0,b0,C.S),C.aj),C.od,A.Z(a7.vf(A.qY(new A.eJ(Date.now(),0,!1))),b0,b0,b0,A.b4().$2$color$fontSize(n.aj(0.65),12),C.dE,b0)],a8),C.X,C.x,C.B),b0),b0,b0),b0,new A.ae(w,16,w,28),C.af)},
$S:212}
B.ayA.prototype={
$0(){var x,w=null
A.aRB()
x=this.a
if(x.e==null)return
x.am(y.f).f.Ev(A.apa(w,w,w,w,C.hM,C.W,w,A.Z(this.b.gEB(),w,w,w,w,w,w),w,C.iH,w,w,w,w,w,w,w,w,w,w))},
$S:0}
B.ayB.prototype={
$0(){var x,w=null
A.aRq()
x=this.a
if(x.e==null)return
x.am(y.f).f.Ev(A.apa(w,w,w,w,C.hM,C.W,w,A.Z(this.b.gvA(),w,w,w,w,w,w),w,C.iH,w,w,w,w,w,w,w,w,w,w))},
...
var y={p:A.a3("fK"),e:A.a3("q<e>"),h:A.a3("fQ"),k:A.a3("ms"),f:A.a3("xt")};(function constants(){D.LS=new B.aBm()
D.LT=new B.aBn()
D.LU=new B.aBo()
D.OK=new A.ae(0,0,0,18)
D.PN=new A.bz(57690,"MaterialIcons",!1)
D.Qo=new A.du(D.PN,20,null,null,null)})()};
(a=>{a["wdljp6px+lYvDWMWVgMp3EdRFzo="]=a.current})($__dart_deferred_initializers__);