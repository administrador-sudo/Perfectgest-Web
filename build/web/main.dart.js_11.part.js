...
b_l(d){switch(d.al(x.h).r.f.gcz()){case"en":return A.LS
case"es":return A.LT
...
aB_:function aB_(){},
aB0:function aB0(){},
b_K(d,e){return new B.oa(e,d,null)},
...
B.oa.prototype={
ab(){var w=null,v=x.z
return new B.a4_(C.Dc(),new C.b5(w,v),new C.b5(w,v),new C.b5(w,v),new C.b5(w,v))}}
B.a4_.prototype={
aw(){this.aQ()
C.mz()
...
$.Z.k4$.push(new B.aBs(this))},
l(){this.d.l()
C.xD()
this.aG()},
alk(){var w=this,v=C.aA(["clean-arch",w.e,"seguranca",w.f,"escala",w.r,"full-stack",w.w],x.w,x.d).h(0,w.a.d),u=v==null?null:$.Z.ai$.x.h(0,v)
if(u==null)return
...
q=j.k3
p=C.Y(g.gDc(),k,k,k,C.bc().$2$color$fontWeight(q,D.aQ),k,k)
o=x.u
n=C.b([],o)
l.a.toString
s=C.a7b(n,s,r,D.p,p)
r=w.gMo()
r=C.b([C.Y(r,k,k,k,C.bc().$4$color$fontSize$fontWeight$height(q,i?22:26,D.aR,1.2),k,k),D.cl,C.Y(w.gMk(),k,k,k,C.bc().$3$color$fontSize$height(q.an(0.82),14,1.5),k,k),D.bV,C.Y(w.gMl(),k,k,k,C.bc().$3$color$fontSize$height(q.an(0.8),13.6,1.5),k,k),D.d_,C.Y(w.gNt(),k,k,k,C.bc().$3$color$fontSize$fontWeight(q,18,D.aR),k,k),D.cl],o)
...
v=p.ry
if(v==null){v=p.n
if(v==null)v=p.k3}v=C.j_(v.an(0.35),1)
u=p.b
t=x.u
s=C.b([C.Y(r.c,q,q,q,C.bc().$3$color$fontSize$fontWeight(u,15.5,D.aQ),q,q),D.eg,D.kG,C.Y(r.f,q,q,q,C.bc().$4$color$fontSize$fontWeight$height(u.an(0.9),12.8,D.aQ,1.4),q,q),C.Y(r.d,q,q,q,C.bc().$3$color$fontSize$height(p.k3.an(0.84),12.8,1.45),q,q)],t)
D.b.a0(s,C.b([D.bV,C.Y(r.e,q,q,q,C.bc().$4$color$fontSize$fontWeight$height(u.an(0.92),12.8,D.aj,1.45),q,q)],t))
