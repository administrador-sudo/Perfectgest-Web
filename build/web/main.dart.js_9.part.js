...
aXV(d){switch(d.an(x.h).r.f.gcJ()){case"en":return A.KS
case"es":return A.KT
...
gLw(){return"Stack Flutter e tecnologias da Perfect Gest Dev"},
gLs(){return"Nossa estrat\xe9gia t\xe9cnica conecta arquitetura, dados, experi\xeancia de utiliza\xe7\xe3o e opera\xe7\xe3o cont\xednua. Cada componente abaixo foi pensado para funcionar em conjunto, reduzindo riscos e acelerando entregas com qualidade previs\xedvel."},
...
gLs(){return"Our technical strategy connects architecture, data, user experience and continuous operations. Each component below is designed to work together, reducing risk and accelerating predictable-quality delivery."},
...
gLs(){return"Nuestra estrategia tecnica conecta arquitectura, datos, experiencia de uso y operacion continua. Cada componente debajo esta pensado para funcionar junto, reducir riesgos y acelerar entregas con calidad previsible."},
...
B.lX.prototype={
ag(){var w=null,v=x.z
return new B.a2I(C.CC(),new C.b8(w,v),new C.b8(w,v),new C.b8(w,v),new C.b8(w,v))}}
B.a2I.prototype={
aw(){this.aU()
C.xm()
...
s=C.aGM(d)
r=C.er(!1,k,k,k,C.cz(D.iM,j.b,k,k),k,k,new B.azq(d),k,k,k,g.gBQ())
q=j.k3
...
s=C.a5X(n,s,r,D.p,p)
r=w.gLw()
r=C.b([C.a7(r,k,k,k,C.b4().$4$color$fontSize$fontWeight$height(q,i?22:26,D.aS,1.2),k,k),D.ck,C.a7(w.gLs(),k,k,k,C.b4().$3$color$fontSize$height(q.aj(0.82),14,1.5),k,k),D.cz,C.a7(w.gLt(),k,k,k,C.b4().$3$color$fontSize$height(q.aj(0.8),13.6,1.5),k,k),D.cW,C.a7(w.gME(),k,k,k,C.b4().$3$color$fontSize$fontWeight(q,18,D.aS),k,k),D.ck],o)
for(m=0;w.gpS(),m<15;++m){i=C.b([],o)
if(m===4)i.push(D.cz)
q=m<4?v[m]:k
p=w.gJj()
i.push(new B.a2H(w.gpS()[m].a,w.gpS()[m].b,w.gpS()[m].c,p,q))
D.b.a_(r,i)}return C.aX(k,k,C.kq(s,t,new C.jd(C.it(C.dP(new C.dk(A.Ji,C.c2(r,D.a1,D.A,D.D),k),k,k),l.d,new C.ag(h,16,h,28),D.ae),k),k),!1,k,k,k,!1,k,k,k,k,k,k,k,u,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,k,D.r,k)}}
B.a2H.prototype={
...
$S:5}
B.azq.prototype={
$0(){return C.d8(this.a,!1).auD(new B.azp())},
$S:0}
B.azp.prototype={
$1(d){return d.gro()},
$S:553};(function inheritance(){var w=a.inheritMany,v=a.inherit
w(C.I,[B.bH,B.amU])
w(B.amU,[B.az0,B.ayZ,B.az_])
v(B.lX,C.T)
v(B.a2I,C.X)
w(C.fT,[B.azr,B.azp])
v(B.azq,C.iP)
v(B.a2H,C.ae)})()
C.x7(b.typeUniverse,JSON.parse('{"lX":{"T":[],"e":[]},"a2I":{"X":["lX"]},"a2H":{"ae":[],"e":[]}}'))
var y={c:"Parceiros tecnol\xf3gicos | Perfect Gest Dev"}
var x={F:C.a1("fy"),d:C.a1("i9<X<T>>"),c:C.a1("q<bH>"),u:C.a1("q<e>"),z:C.a1("b8<X<T>>"),x:C.a1("fp"),w:C.a1("o"),h:C.a1("kI")};(function constants(){var w=a.makeConstList
...
A.a_p=w([A.a9W,A.aa9,A.a9u,A.a9J,A.a9O,A.a9Q,A.a9N,A.aab,A.a9D,A.a9Z,A.aa5,A.aaa,A.a9w,A.a9C,A.aa6],x.c)
...
A.a_R=w([A.a9H,A.a9A,A.a9y,A.a9Y,A.a9F,A.aa2,A.aa7,A.aa3,A.aa8,A.a9X,A.a9T,A.a9B,A.a9z,A.a9L,A.aa_],x.c)
...
A.a_U=w([A.a9K,A.a9v,A.a9R,A.a9P,A.a9x,A.a9I,A.a9U,A.a9M,A.a9E,A.aa0,A.aa1,A.a9S,A.aa4,A.a9V,A.a9G],x.c)})()};
(a=>{a["TZUj+10/FwW19uFrnRsGNZVSH24="]=a.current})($__dart_deferred_initializers__);