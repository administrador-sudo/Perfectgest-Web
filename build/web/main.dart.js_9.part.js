...
aXW(d){switch(d.an(x.h).r.f.gcJ()){case"en":return A.KT
case"es":return A.KU
case"pt":default:return A.KV}},
...
aw(){this.aU()
C.xm()
C.ho("description","Parceiros tecnol\xf3gicos e stack Flutter da Perfect Gest Dev: Clean Architecture, seguran\xe7a, escala, integra\xe7\xf5es e opera\xe7\xe3o cont\xednua.")
C.ho("keywords","Perfect Gest Dev, tecnologias, Flutter, Dart, Java, Gradle, SDK, integra\xe7\xf5es, arquitetura limpa, seguran\xe7a, escala")
C.ho("robots","index, follow")
C.ef("og:title",y.c)
C.ef("og:description","Vis\xe3o t\xe9cnica do stack Perfect Gest Dev para mobile, web e desktop com foco em performance e previsibilidade.")
C.ef("og:type","article")
C.ef("og:locale","pt_BR")
b.G.document.title=y.c
$.Y.k4$.push(new B.azr(this))},
l(){this.d.l()
C.xf()
this.aJ()},
ajD(){var w=this,v=C.az(["clean-arch",w.e,"seguranca",w.f,"escala",w.r,"full-stack",w.w],x.w,x.d).h(0,w.a.d),u=v==null?null:$.Y.ah$.x.h(0,v)
if(u==null)return
C.aFa(u,0.24,D.GJ,D.cL,D.pS)},
I(d){var w,v,u,t,s,r,q,p,o,n,m,l=this,k=null,j=C.F(d).ax,i=C.ba(d,D.aG,x.x).w.a.a<400,h=i?16:24,g=C.cw(d,D.aD,x.F)
g.toString
w=B.aXW(d)
C.F(d)
v=[l.e,l.f,l.r,l.w]
u=w.ghm()
t=C.F(d).ax.a===D.F?D.p:k
s=C.aGM(d)
r=C.eF(!1,k,k,k,C.cH(D.iJ,j.b,k,k),k,k,new B.azq(d),k,k,k,g.gBQ())
q=j.k3
p=C.a5(g.gwj(),k,k,k,C.b1().$2$color$fontWeight(q,D.aM),k,k)
o=x.u
n=C.b([],o)
l.a.toString
s=C.a5Y(n,s,r,D.p,p)
r=w.gLw()
r=C.b([C.a5(r,k,k,k,C.b1().$4$color$fontSize$fontWeight$height(q,i?22:26,D.aN,1.2),k,k),D.ck,C.a5(w.gLs(),k,k,k,C.b1().$3$color$fontSize$height(q.aj(0.82),14,1.5),k,k),D.cz,C.a5(w.gLt(),k,k,k,C.b1().$3$color$fontSize$height(q.aj(0.8),13.6,1.5),k,k),D.cW,C.a5(w.gME(),k,k,k,C.b1().$3$color$fontSize$fontWeight(q,18,D.aN),k,k),D.ck],o)
for(m=0;w.gpQ(),m<15;++m){i=C.b([],o)
if(m===4)i.push(D.cz)
q=m<4?v[m]:k
p=w.gJj()
...
u=p.b
t=x.u
s=C.b([C.a5(r.c,q,q,q,C.b1().$3$color$fontSize$fontWeight(u,15.5,D.aM),q,q),D.dw,D.kp,C.a5(r.f,q,q,q,C.b1().$4$color$fontSize$fontWeight$height(u.aj(0.9),12.8,D.aM,1.4),q,q),C.a5(r.d,q,q,q,C.b1().$3$color$fontSize$height(p.k3.aj(0.84),12.8,1.45),q,q)],t)
D.b.a_(s,C.b([D.cz,C.a5(r.e,q,q,q,C.b1().$4$color$fontSize$fontWeight$height(u.aj(0.92),12.8,D.bo,1.45),q,q)],t))
return new C.bu(A.NM,C.eo(new C.bu(A.NW,C.c2(s,D.a1,D.A,D.D),q),new C.bU(o,q,v,w,q,q,D.Y),D.az),q)}}
var z=a.updateTypes([])
B.azr.prototype={
...
A.aa_=new B.bH("Full-Stack","Actuamos de front-end a back-end, conectando Flutter, APIs, servicios de datos, integraciones corporativas y automatizacion de build. Garantizamos entregas coherentes en todo el ciclo del producto.","Ejemplo practico: publicamos una funcionalidad completa de venta, desde la pantalla movil hasta API, base de datos y monitorizacion.")
A.a9H=new B.bH("Flutter + Dart (base multiplataforma)","Usamos Flutter como framework principal y Dart como lenguaje para entregar una base unica de codigo con alta productividad, consistencia de interfaz y excelente rendimiento en Android, iOS, Web y Desktop.","Ejemplo practico: un mismo modulo de registro se comparte entre movil y web, reduciendo retrabajo y tiempo de lanzamiento.")
A.aa4=new B.bH("Base de datos offline (Dart/Flutter)","Para persistencia local y uso sin internet usamos SQLite (sqflite/drift), Isar y Hive. Esta capa local mantiene rendimiento, respuesta rapida de la interfaz y continuidad con conectividad limitada.","Ejemplo practico: un tecnico en campo registra atencion sin internet y la app conserva los datos locales hasta que vuelva la conexion.")
A.aa9=new B.bH("Base de datos online (Dart/Flutter)","Para sincronizacion y datos en la nube trabajamos con Cloud Firestore, Firebase Realtime Database y Supabase/PostgreSQL. Permite backup, actualizacion casi en tiempo real y acceso multiusuario fiable en produccion.","Ejemplo practico: cambios de stock hechos en el panel web aparecen casi en tiempo real en la app del equipo comercial.")
A.aa5=new B.bH("Java (integraciones y backend enterprise)","Utilizamos Java en integraciones corporativas y servicios de apoyo para entornos que exigen robustez, seguridad y compatibilidad con ecosistemas enterprise, conectando apps Flutter a APIs y sistemas legacy.","Ejemplo practico: integracion con ERP legacy para sincronizar pedidos y facturacion sin alterar el sistema principal del cliente.")
A.aaa=new B.bH("Gradle (build y automatizacion Android)","En Android usamos Gradle para dependencias, variantes de build y automatizacion de pipeline. Mejora la previsibilidad de releases, la organizacion de entornos y la calidad continua de entrega.","Ejemplo practico: generamos builds separados para homologacion y produccion con variables de entorno y firmas distintas.")
A.a9Z=new B.bH("SDKs de terceros e integraciones nativas","Integramos SDKs nativos y bibliotecas especializadas para negocio: autenticacion, pagos, analytics, notificaciones y servicios propietarios, manteniendo estabilidad y rendimiento en produccion.","Ejemplo practico: a\xf1adimos pasarela de pago y autenticacion biometrica manteniendo UX fluida en Android e iOS.")
A.a9V=new B.bH("Material 3 y UI responsiva","Adoptamos Material 3, LayoutBuilder y breakpoints responsivos para interfaces adaptables a moviles, tablets y escritorio. Mejora la experiencia de usuario, retencion y metricas de usabilidad.","Ejemplo practico: la misma jornada de compra se reorganiza automaticamente en tablet y escritorio sin duplicar pantallas.")
A.a9D=new B.bH("Integraciones web y SEO tecnico","Implementamos metatags dinamicas, Open Graph, canonical, robots.txt y sitemap.xml para mejorar rastreo e indexacion en Google. Tambien aplicamos buenas practicas con Content Security Policy y politicas de permisos.","Ejemplo practico: la pagina de servicio gana preview optimizado en WhatsApp y mejor posicionamiento organico en Google.")
