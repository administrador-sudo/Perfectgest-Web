...
b0c(d){switch(d.am(y.k).r.f.gcs()){case"en":return D.M_
case"es":return D.M0
case"pt":default:return D.M1}},
ap5:function ap5(){},
aBz:function aBz(){},
aBx:function aBx(){},
aBy:function aBy(){},
b_4(d){return new B.nT(d,null)},
nT:function nT(d,e){this.c=d
this.a=e},
a25:function a25(){this.c=this.a=null},
...
gk8(){return"Perfect Gest Dev"},
gkd(){return"Privacy policy, personal data, cookies and terms of use"},
pt(d){return"Last updated: institutional document. If you have questions about data processing, contact: "+d+"."},
gnS(){return"1. Who we are"},
gnR(){return"This document applies to the institutional website https://perfectgestdev.com, operated by Perfect Gest Dev (PERFECT GEST DESENVOLVIMENTO DE SOFTWARE LTDA). We are a software house for mobile, web and desktop development. It covers cookies, audience measurement, the pre-registration form and contact on this site \u2014 not the mobile app. Legal documentation for the PerfectGest I product (FAQ, privacy, data deletion and terms) is not part of this document \u2014 see the Solutions section of this site."},
gnU(){return"2. Data we may collect"},
gnT(){return"\u2022 Technical browsing data: IP address (often truncated or aggregated by the analytics provider), browser type, language, pages visited and approximate times.\n\u2022 Data you send voluntarily: for example, if you contact us via WhatsApp or email, the message content and metadata needed for communication.\n\u2022 Pre-registration form data (name, email, optional comment and language): collected only with your explicit consent, sent over HTTPS to a database managed by us (Render hosting). We use this data for commercial contact, pre-launch program invitations (access to in-development builds and feedback collection), product updates and responding to requests. We do not sell these contacts to third parties.\nWe do not sell contact lists or personal data to third parties for independent commercial purposes."},
gnW(){return"3. Cookies and similar technologies"},
gnV(){return"We use cookies and local storage strictly necessary for the site to work and, when enabled with your consent, audience measurement cookies to understand in aggregate how the site is used. You can manage or delete cookies in your browser settings. If you decline measurement cookies, we limit analytics signals according to your browser configuration and our consent settings."},
gnY(){return"4. Audience measurement"},
gnX(){return"When you enable audience measurement, we use an external aggregated statistics provider. Processing is limited to technical and aggregated data; we do not sell personal data. You can change your choice at any time via \xabManage cookies\xbb in the footer or on this page."},
...
gk8(){return"Perfect Gest Dev"},
gkd(){return"Politica de privacidad, datos personales, cookies y terminos de uso"},
pt(d){return"Ultima actualizacion: documento institucional. Si tiene dudas sobre el tratamiento de datos, contacte: "+d+"."},
gnS(){return"1. Quienes somos"},
gnR(){return"Este documento se aplica al sitio institucional https://perfectgestdev.com, operado por Perfect Gest Dev (PERFECT GEST DESENVOLVIMENTO DE SOFTWARE LTDA). Somos una software house de desarrollo movil, web y escritorio. Cubre cookies, medicion de audiencia, formulario de pre-registro y contacto en este sitio \u2014 no la aplicacion movil. La documentacion legal del producto PerfectGest I (FAQ, privacidad, eliminacion de datos y terminos) no forma parte de este documento \u2014 consulte la seccion Soluciones de este sitio."},
gnU(){return"2. Datos que podemos recopilar"},
gnT(){return"\u2022 Datos tecnicos de navegacion: direccion IP (a menudo truncada o agregada por el proveedor de analytics), tipo de navegador, idioma, paginas visitadas y horarios aproximados.\n\u2022 Datos que nos envie voluntariamente: por ejemplo, si nos contacta por WhatsApp o correo, el contenido del mensaje y los metadatos necesarios para la comunicacion.\n\u2022 Datos del formulario de pre-registro (nombre, correo, comentario opcional e idioma): recopilados solo con su consentimiento explicito, transmitidos por HTTPS a una base de datos gestionada por nosotros (alojamiento Render). Utilizamos estos datos para contacto comercial, invitaciones al programa de prelanzamiento (acceso a builds en desarrollo y recogida de retroalimentacion), novedades sobre productos y respuesta a solicitudes. No vendemos estos contactos a terceros.\nNo vendemos listas de contactos ni datos personales a terceros para fines comerciales independientes."},
gnW(){return"3. Cookies y tecnologias similares"},
gnV(){return"Utilizamos cookies y almacenamiento local estrictamente necesarios para el funcionamiento del sitio y, cuando esta activado con su consentimiento, cookies de medicion de audiencia para entender de forma agregada como se usa el sitio. Puede gestionar o borrar cookies en la configuracion del navegador. Si rechaza cookies de medicion, limitamos el envio de senales de analytics segun la configuracion del navegador y nuestras opciones de consentimiento."},
gnY(){return"4. Medicion de audiencia"},
gnX(){return"Cuando activa la medicion de audiencia, utilizamos un proveedor externo de estadisticas agregadas. El tratamiento se limita a datos tecnicos y agregados; no vendemos datos personales. Puede cambiar su eleccion en cualquier momento en \xabGestionar cookies\xbb del pie de pagina o en esta pagina."},
...
l(){A.to()
this.aG()},
F(d){var x,w,v,u,t=null,s=A.C(d),r=A.b2(d,C.al,y.h).w.a.a,q=r<400?16:24,p=A.cm(d,C.ar,y.p)
p.toString
x=B.b0c(d)
w=x.gf0()
v=A.C(d).ax.a===C.E?C.bw:C.bb
u=x.ghH()
return A.aR(t,t,A.jv(F.aG9(d,new B.ayK(d),this.a.c,u),v,new A.kK(A.nv(new B.ayL(q,x,s.ax,r,p)),t),t),!1,t,t,t,!1,t,t,t,t,t,t,t,w,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,C.p,t)}}
B.kY.prototype={
F(d){var x,w,v,u,t=null,s=A.C(d).ax,r=A.b2(d,C.al,y.h).w.a.a,q=r<400?12:16,p=this.c,o=s.RG
o=(o==null?s.k2:o).ad(0.5)
x=A.cX(14)
w=s.ry
if(w==null){w=s.n
if(w==null)w=s.k3}w=A.hD(w.ad(0.4),1)
v=r<360
u=v?15:16
u=A.T(p,t,t,t,A.aN().$3$color$fontSize$fontWeight(s.b,u,C.aD),t,t)
v=v?13:14
return new A.bk(G.qw,A.aR(t,t,A.dr(new A.bk(new A.ad(q,16,q,18),A.bS(A.b([u,C.bh,A.T(this.d,t,t,t,A.aN().$3$color$fontSize$height(s.k3.ad(0.88),v,1.55),t,t)],y.e),C.W,C.w,C.z),t),new A.bM(o,t,w,x,t,t,C.S),C.aj),!0,t,t,t,!1,t,t,t,t,t,t,t,p,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,t,C.p,t),t)}}
var z=a.updateTypes([])
B.ayK.prototype={
$0(){return A.cU(this.a,!1).dG()},
$S:0}
B.ayL.prototype={
...
b2=b2<1/0&&isFinite(b2)?b2:A.b2(b3,C.al,y.h).w.a.a
x=C.d.cT(b2<720?b2:720,200,720)
w=a9.a
v=a9.b
u=a9.c
t=u.b
s=A.T(v.gk8(),b0,b0,b0,A.aN().$4$color$fontSize$fontWeight$letterSpacing(t,13,C.aD,0.4),b0,b0)
r=v.gkd()
q=a9.d
p=q<400
o=p?18:22
n=u.k3
o=A.T(r,b0,b0,b0,A.aN().$4$color$fontSize$fontWeight$height(n,o,C.aO,1.2),b0,b0)
r=A.T(v.pt(b1),b0,b0,b0,A.aN().$3$color$fontSize$height(n.ad(0.72),13,1.45),b0,b0)
m=v.gnS()
l=v.gnR()
k=v.gnU()
j=v.gnT()
...
u=A.hD(u.ad(0.45),1)
p=p?14:16
a5=A.T(v.gKC(),b0,b0,b0,A.aN().$3$color$fontSize$fontWeight(n,14,C.aD),b0,b0)
a6=A.T(v.gKB(),b0,b0,b0,A.aN().$3$color$fontSize$height(n.ad(0.8),12.5,1.45),b0,b0)
a7=a9.e
a8=y.e
return A.hY(A.dL(new A.dg(new A.a9(0,x,0,1/0),A.bS(A.b([s,C.bi,o,C.bh,r,C.em,new B.kY(m,l,b0),new B.kY(k,j,b0),new B.kY(i,h,b0),new B.kY(g,f,b0),new B.kY(e,d,b0),new B.kY(a0,a1,b0),new B.kY(a2,a3,b0),C.fo,A.dr(new A.bk(new A.ad(p,p,p,p),A.bS(A.b([a5,C.b0,a6,C.ce,A.iS(C.bE,A.b([A.aca(D.Qv,A.T(q<360?v.gJo():v.gJn(),b0,b0,b0,b0,C.dG,b0),new B.ayI(b3,v),b0),new A.C3(!1,new B.ayJ(b3,a7),b0,b0,b0,b0,b0,b0,!1,b0,!0,b0,A.T(a7.gvz(),b0,b0,b0,b0,b0,b0),b0)],a8),C.cN,8,8)],a8),C.bc,C.w,C.z),b0),new A.bM(t,b0,u,a4,b0,b0,C.S),C.aj),C.od,A.T(a7.r6(A.nY(new A.ev(Date.now(),0,!1))),b0,b0,b0,A.aN().$2$color$fontSize(n.ad(0.65),12),C.dG,b0)],a8),C.W,C.w,C.z),b0),b0,b0),b0,new A.ad(w,16,w,28),C.ah)},
$S:116}
B.ayI.prototype={
$0(){var x,w=null
A.aRN()
x=this.a
if(x.e==null)return
x.am(y.f).f.Ev(A.aph(w,w,w,w,C.hO,C.Y,w,A.T(this.b.gEB(),w,w,w,w,w,w),w,C.iJ,w,w,w,w,w,w,w,w,w,w))},
$S:0}
B.ayJ.prototype={
$0(){var x,w=null
A.aRC()
x=this.a
if(x.e==null)return
x.am(y.f).f.Ev(A.aph(w,w,w,w,C.hO,C.Y,w,A.T(this.b.gvz(),w,w,w,w,w,w),w,C.iJ,w,w,w,w,w,w,w,w,w,w))},
$S:0};(function inheritance(){var x=a.inherit,w=a.inheritMany
x(B.ap5,A.J)
w(B.ap5,[B.aBz,B.aBx,B.aBy])
x(B.nT,A.U)
x(B.a25,A.Y)
w(A.j8,[B.ayK,B.ayI,B.ayJ])
x(B.ayL,A.mT)
x(B.kY,A.a4)})()
A.tk(b.typeUniverse,JSON.parse('{"nT":{"U":[],"e":[]},"a25":{"Y":["nT"]},"kY":{"a4":[],"e":[]}}'))
var y={p:A.a1("fk"),e:A.a1("p<e>"),h:A.a1("fz"),k:A.a1("kX"),f:A.a1("xB")};(function constants(){D.M_=new B.aBx()
D.M0=new B.aBy()
D.M1=new B.aBz()
D.PU=new A.bA(57690,"MaterialIcons",!1)
D.Qv=new A.dx(D.PU,20,null,null,null)})()};
(a=>{a["Xl2gf/vOHnBTR4quzoAHlH88Go8="]=a.current})($__dart_deferred_initializers__);