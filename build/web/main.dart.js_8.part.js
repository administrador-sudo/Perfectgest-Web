...
aXL(d){switch(d.an(x.h).r.f.gcN()){case"en":return A.KQ
case"es":return A.KR
...
gJm(){return"Concepto aplicado:"},
gpR(){return A.a_d}}
B.lR.prototype={
ag(){var w=null,v=x.z
return new B.a2G(C.Cx(),new C.b8(w,v),new C.b8(w,v),new C.b8(w,v),new C.b8(w,v))}}
B.a2G.prototype={
az(){this.aV()
C.a4W()
C.hl("description","Parceiros tecnol\xf3gicos e stack Flutter da Perfect Gest Dev: Clean Architecture, seguran\xe7a, escala, integra\xe7\xf5es e opera\xe7\xe3o cont\xednua.")
C.hl("keywords","Perfect Gest Dev, tecnologias, Flutter, Dart, Java, Gradle, SDK, integra\xe7\xf5es, arquitetura limpa, seguran\xe7a, escala")
C.hl("robots","index, follow")
C.ed("og:title",y.c)
...
$.Z.k4$.push(new B.azk(this))},
l(){this.d.l()
C.x7()
this.aL()},
ajA(){var w=this,v=C.az(["clean-arch",w.e,"seguranca",w.f,"escala",w.r,"full-stack",w.w],x.w,x.d).h(0,w.a.d),u=v==null?null:$.Z.ah$.x.h(0,v)
if(u==null)return
C.aF0(u,0.24,D.GK,D.cp,D.pR)},
...
s=C.aGC(d)
r=C.eD(!1,k,k,k,C.cG(D.iJ,j.b,k,k),k,k,new B.azj(d),k,k,k,g.gBS())
q=j.k3
p=C.a9(g.gwl(),k,k,k,C.b1().$2$color$fontWeight(q,D.aM),k,k)
o=x.u
n=C.b([],o)
l.a.toString
s=C.a5T(n,s,r,D.p,p)
r=w.gLw()
r=C.b([C.a9(r,k,k,k,C.b1().$4$color$fontSize$fontWeight$height(q,i?22:26,D.aN,1.2),k,k),D.c0,C.a9(w.gLs(),k,k,k,C.b1().$3$color$fontSize$height(q.al(0.82),14,1.5),k,k),D.cW,C.a9(w.gLt(),k,k,k,C.b1().$3$color$fontSize$height(q.al(0.8),13.6,1.5),k,k),D.cV,C.a9(w.gME(),k,k,k,C.b1().$3$color$fontSize$fontWeight(q,18,D.aN),k,k),D.c0],o)
for(m=0;w.gpR(),m<15;++m){i=C.b([],o)
if(m===4)i.push(D.cW)
q=m<4?v[m]:k
p=w.gJm()
i.push(new B.a2F(w.gpR()[m].a,w.gpR()[m].b,w.gpR()[m].c,p,q))
...
u=p.b
t=x.u
s=C.b([C.a9(r.c,q,q,q,C.b1().$3$color$fontSize$fontWeight(u,15.5,D.aM),q,q),D.ed,D.kq,C.a9(r.f,q,q,q,C.b1().$4$color$fontSize$fontWeight$height(u.al(0.9),12.8,D.aM,1.4),q,q),C.a9(r.d,q,q,q,C.b1().$3$color$fontSize$height(p.k3.al(0.84),12.8,1.45),q,q)],t)
D.b.a_(s,C.b([D.cW,C.a9(r.e,q,q,q,C.b1().$4$color$fontSize$fontWeight$height(u.al(0.92),12.8,D.bq,1.45),q,q)],t))
return new C.by(A.NH,C.em(new C.by(A.NQ,C.cc(s,D.a7,D.C,D.E),q),new C.bU(o,q,v,w,q,q,D.Y),D.aA),q)}}
var z=a.updateTypes([])
B.azk.prototype={
$1(d){return this.a.ajA()},
$S:5}
B.azj.prototype={
$0(){return C.d7(this.a,!1).auC(new B.azi())},
$S:0}
B.azi.prototype={
$1(d){return d.grn()},
$S:551};(function inheritance(){var w=a.inheritMany,v=a.inherit
w(C.I,[B.bH,B.amN])
w(B.amN,[B.ayU,B.ayS,B.ayT])
v(B.lR,C.T)
v(B.a2G,C.X)
w(C.hp,[B.azk,B.azi])
v(B.azj,C.jI)
v(B.a2F,C.ag)})()
C.HQ(b.typeUniverse,JSON.parse('{"lR":{"T":[],"e":[]},"a2G":{"X":["lR"]},"a2F":{"ag":[],"e":[]}}'))
var y={c:"Parceiros tecnol\xf3gicos | Perfect Gest Dev"}
var x={F:C.a2("fx"),d:C.a2("i5<X<T>>"),c:C.a2("r<bH>"),u:C.a2("r<e>"),z:C.a2("b8<X<T>>"),x:C.a2("fB"),w:C.a2("o"),h:C.a2("md")};(function constants(){var w=a.makeConstList
...
(a=>{a["G+I+R1b95SesvK+G95Alhfy+x/E="]=a.current})($__dart_deferred_initializers__);