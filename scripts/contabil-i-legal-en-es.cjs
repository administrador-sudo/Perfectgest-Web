...
module.exports = {
  ...
  terms: {
    en: [
      ...
      { heading: '4. Plans and subscriptions (Google Play)', body: 'The App is free to install. Full access requires a Google Play subscription:\n\nPlan · Reference · Includes\nBásico Mensal · R$ 19.90/month · Cash book · IR with AI · Issued invoices · AI Assistant\nBásico Anual · R$ 179.00/year · Same as Básico Mensal + ~25% discount\nCom Contador · R$ 59.90/month · Everything in Básico + CRC review + accountant access + company opening\nAnual + A1 · R$ 718.90/year · Everything in Com Contador + CNPJ A1 digital certificate (bonus)\n\n- Payment, renewal and cancellation follow Google Play rules.\n- Store prices prevail over reference values above.\n- Basic plans (monthly and annual) do not include accountant access or CRC review.\n- Product IDs: contabil_i_mensal, contabil_i_basico_anual, contabil_i_contabil_plus, contabil_i_anual.' },
    ...
    es: [
      ...
      { heading: '4. Planes y suscripciones (Google Play)', body: 'La App es gratuita para instalar. El acceso completo requiere suscripción gestionada por Google Play:\n\nPlan · Referencia · Incluye\nBásico Mensual · R$ 19,90/mes · Libro de caja · IR con IA · NF emitidas · Asistente IA\nBásico Anual · R$ 179,00/año · Igual al Básico Mensual + ~25% de descuento\nCom Contador · R$ 59,90/mes · Todo del Básico + revisión CRC + acceso al contador + apertura de empresa\nAnual + A1 · R$ 718,90/año · Todo del Com Contador + certificado digital CNPJ A1 (bono)\n\n- Pago, renovación y cancelación siguen las reglas de Google Play.\n- Los precios en la tienda prevalecen sobre los valores de referencia.\n- Los planes Básico (mensual y anual) no incluyen acceso a contador ni revisión CRC.\n- IDs de producto: contabil_i_mensal, contabil_i_basico_anual, contabil_i_contabil_plus, contabil_i_anual.' },
