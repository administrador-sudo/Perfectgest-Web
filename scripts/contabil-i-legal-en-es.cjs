...
module.exports = {
  ...
  faq: {
    en: [
      ...
      { heading: 'Does the app replace my accountant?', body: 'No. It is a recording and support tool. Com Contador (monthly) and configurable annual package plans include PerfectGest services (review and, per plan, company opening), but official filings and opinions may require an accounting contract with a CRC professional.' },
      { heading: 'Does the app move money or connect to the bank?', body: 'No. Manual entries; bank statement balance entered at month-end closing.' },
      {
        ...
        body:
          ...
          '<tr><td>Configurable annual package (Build your plan)</td><td>12× R$ 69.90–119.90</td></tr>' +
          '<tr><td>Standalone A1 certificate</td><td>R$ 119.00</td></tr>' +
          '</tbody></table>\n\n' +
      ...
      },
      {
        ...
        body:
          '<table class="compare-table"><thead><tr><th>Included</th><th>Basic (monthly or annual)</th><th>Com Contador (monthly)</th><th>Annual package (with certificate)</th></tr></thead><tbody>' +
      ...
      { heading: 'What does "company opening" mean in Com Contador and annual package plans?', body: 'Support service for incorporation/registration of your company (ME, MEI or applicable form), by PerfectGest or partners after plan subscription and document submission.' },
      ...
      { heading: 'A1 certificate (annual package / standalone)', body: 'Promotional e-CNPJ A1 via Quality Cert on configurable annual package subscriptions (contabil_i_pacote_* / contabil_i_pac_*). Standalone contabil_i_certificado_a1 = issuance only.\n\n1. Active subscription validated on Play\n2. Menu Certificado A1 → Register certificate data\n3. Promo code / Quality link when assigned by Firebase\n\nBasic and Com Contador monthly plans do not include A1.' },
    ...
    es: [
      ...
      { heading: '¿La app sustituye a mi contador?', body: 'No. Es herramienta de registro y apoyo. Planes Com Contador (mensual) y paquete anual configurable incluyen servicios PerfectGest (revisión y, según plan, apertura de empresa), pero declaraciones oficiales y dictámenes pueden exigir contrato contable con profesional CRC.' },
      { heading: '¿Mueve dinero o conecta al banco?', body: 'No. Movimientos manuales; saldo de extracto informado en el cierre del mes.' },
      {
        ...
        body:
          ...
          '<tr><td>Paquete anual configurable (Monte su plan)</td><td>12× R$ 69,90–119,90</td></tr>' +
          '<tr><td>Certificado A1 avulso</td><td>R$ 119,00</td></tr>' +
          '</tbody></table>\n\n' +
      ...
      },
      {
        ...
        body:
          '<table class="compare-table"><thead><tr><th>Incluido</th><th>Básico (mensual o anual)</th><th>Com Contador (mensual)</th><th>Paquete anual (con certificado)</th></tr></thead><tbody>' +
          ...
          '</tbody></table>\n\n' +
          'Resumen: Básico = solo app; Com Contador = + revisión y apertura; Paquete anual = 12 cuotas + certificado digital + add-ons opcionales.',
      },
      { heading: '¿Cómo funcionan las faixas Com Contador y paquete anual?', body: '1. En el registro de la empresa, indique tipo de actividad y volumen estimado (movimientos y NF/mes).\n2. La app recomienda Essencial, Standard o Avanzado.\n3. El precio exacto aparece en Google Play.\n4. Tras meses cerrados, la faixa puede recalcularse con datos reales.\n5. Si la operación crece, la app indica upgrade — el cambio de precio se hace solo en Play.\n\nVer Términos de Uso §6.2.' },
      ...
      { heading: '¿Qué significa "apertura de empresa" en planes Com Contador y paquete anual?', body: 'Servicio de apoyo a constitución/registro de su empresa (ME, MEI o forma aplicable), por PerfectGest o socios tras contratar el plan y entregar documentos.' },
      ...
      { heading: 'Certificado A1 (paquete anual / avulso)', body: 'Bono e-CNPJ A1 vía Quality Cert en suscripciones del paquete anual configurable (contabil_i_pacote_* / contabil_i_pac_*). Avulso contabil_i_certificado_a1 = solo emisión.\n\n1. Suscripción activa validada en Play\n2. Menú Certificado A1 → Registrar datos\n3. Código/enlace Quality cuando Firebase lo asigne\n\nPlanes Básico y Com Contador mensual no incluyen A1.' },
