...
const faq = {
  pt: [
    ...
    { heading: "Como funciona o período de teste?", body: "7 dias desde a primeira abertura, com uso ilimitado: clientes, orçamentos, lançamentos de caixa, PDF, ordens de serviço e contratos — sem subscrição paga e sem cartão na app durante esse período.\n\nApós os 7 dias sem Plano Pro: pode consultar e editar o que já está no telemóvel, mas não cria novos registos nem gera novos PDF. Assinatura: Configurações → Ver planos e preços (Google Play)." },
    { heading: "Quanto custa o Plano Pro?", body: "Na Google Play (Brasil): R$ 9,90/mês ou R$ 99,90/ano (equivalente a cerca de R$ 8,33/mês — 2 meses grátis no anual). Preços podem variar por país; a loja mostra o valor final." },
    { heading: "O que aconteceu ao «Plano Inicial 5+5+5»?", body: "Modelo anterior, substituído em 2026. O modelo actual é 7 dias ilimitados + assinatura Pro. Textos antigos em capturas ou reviews podem referir limites que já não se aplicam." },
  ...
  en: [
    ...
    { heading: "How does the trial period work?", body: "7 days from first open with unlimited use: clients, estimates, cash entries, PDF, work orders and contracts — no paid subscription and no card required in the app during the trial.\n\nAfter 7 days without Pro Plan: you can view and edit saved data but cannot create new records or new PDFs. Subscribe in Settings → View plans and pricing (Google Play)." },
    { heading: "How much does Pro Plan cost?", body: "On Google Play (Brazil): R$ 9.90/month or R$ 99.90/year (~R$ 8.33/month — 2 months free on annual). Prices may vary by country; the store shows the final amount." },
    { heading: "What happened to the «5+5+5 Initial Plan»?", body: "Legacy model replaced in 2026. Current model: 7 unlimited days + Pro subscription." },
  ...
  es: [
    ...
    { heading: "¿Cómo funciona el período de prueba?", body: "7 días desde la primera apertura con uso ilimitado: clientes, presupuestos, caja, PDF, órdenes de servicio y contratos — sin suscripción de pago y sin tarjeta en la app durante la prueba.\n\nTras 7 días sin Plan Pro: puede consultar y editar lo guardado, pero no crear registros nuevos ni PDF nuevos. Suscripción: Ajustes → Ver planes y precios (Google Play)." },
    { heading: "¿Cuánto cuesta el Plan Pro?", body: "En Google Play (Brasil): R$ 9,90/mes o R$ 99,90/año (~R$ 8,33/mes — 2 meses gratis en el anual). Los precios pueden variar por país." },
    { heading: "¿Qué pasó con el «Plan Inicial 5+5+5»?", body: "Modelo anterior, sustituido en 2026. Modelo actual: 7 días ilimitados + suscripción Pro." },
