...
const terms = {
  pt: [
    ...
    { heading: "5. Direito de arrependimento (Brasil — CDC)", body: "Direito legal de arrependimento de 7 dias corridos quando aplicável ao consumidor brasileiro, sem prejuízo das regras Google Play. Reembolsos via canais Google." },
    { heading: "6. Lembretes fiscais e orçamentos fiscais", body: "Lembretes e documentos fiscais na app são meramente informativos / de apoio; não substituem contabilista nem constituem emissão oficial de notas fiscais. Responsabilidade do utilizador." },
  ...
  en: [
    { heading: "Introduction", body: "Last updated: July 2026" },
    { heading: "1. Purpose", body: "These Terms govern PerfectGest I (customers, commercial budgets, fiscal quotes on the Quote/NF-e/NFS-e tab — local support documents only; no electronic NF-e/NFS-e issuance, cash, work orders, fiscal reminders, digital business card), with data primarily on your device.\n\nClient and financial data stay on the device and are not transmitted automatically. They may leave only through your actions (share PDF, exported backup, business card PNG/vCard/QR). See Privacy Policy.\n\nPublisher: Marcos Leandro dos Santos." },
    ...
    { heading: "5. Statutory rights (Brazil)", body: "Brazil’s Consumer Code may grant a 7-day withdrawal right where applicable. Refunds via Google Play rules and channels." },
    { heading: "6. Fiscal reminders and fiscal quotes", body: "Informational / support only; not tax advice and not official electronic invoice issuance. User responsibility." },
  ...
  es: [
    ...
    { heading: "4. Cancelación", body: "Google Play Store → Pagos y suscripciones → Suscripciones." },
    { heading: "5. Derecho de desistimiento (Brasil — CDC)", body: "Puede aplicar el derecho legal de desistimiento de 7 días corridos al consumidor brasileño, sin perjuicio de las reglas de Google Play. Reembolsos por canales de Google." },
    { heading: "6. Recordatorios fiscales y presupuestos fiscales", body: "Informativos / de apoyo; no sustituyen asesoría contable ni constituyen emisión oficial de facturas. Responsabilidad del usuario." },
    { heading: "7. Limitación de responsabilidad", body: "Herramienta de apoyo; el usuario es responsable de las decisiones de negocio." },
    { heading: "8. Propiedad intelectual", body: "Licencia revocable, no exclusiva. Prohibida la ingeniería inversa ilícita." },
    { heading: "9. Cambios", body: "Versión vigente en la URL abajo." },
    { heading: "10. Ley y fuero", body: "Leyes de Brasil; fuero Caxias do Sul/RS." },
    { heading: "11. Contacto", body: "suporte@perfectgestdev.com" }
  ],
};
...
const deletion = {
  pt: [
    ...
    { heading: "1. Dados de gestão (local)", body: "Armazenados em SQLite no dispositivo: clientes, orçamentos comerciais, orçamentos fiscais e códigos fiscais, caixa, ordens de serviço, dados da empresa (incluindo logótipo), cópia do cartão de visita, lembretes fiscais.\n\nComo eliminar\n\n- Na app: Configurações → Dados no dispositivo → Eliminar todos os dados neste aparelho\n- Android: Definições → Apps → PerfectGest I → Armazenamento → Limpar dados\n- Desinstalar a app\n\nAviso: sem cópia externa, não há recuperação — não guardamos cópias nos nossos servidores.\n\nBackups partilhados: elimine manualmente no WhatsApp, e-mail ou nuvem onde os guardou." },
    { heading: "2. Firebase / telemetria", body: "Metadados anónimos de instalação e métricas de uso (elegibilidade de assinatura / anti-abuso; consumo do 1.º cartão). Não alojamos conteúdo do cartão de visita nem o logótipo em servidores.\n\nE-mail: suporte@perfectgestdev.com — Assunto: Solicitação de Exclusão de Dados Técnicos" },
  ...
  en: [
    ...
    { heading: "Summary", body: "Client and financial data are not sent automatically to PerfectGest servers. They leave the phone only if you share PDFs, exported backup files, business card PNG/vCard, or show a QR with professional contacts." },
    { heading: "1. Local management data", body: "Stored in SQLite on the device: clients, commercial estimates, fiscal quotes and fiscal codes, cash, work orders, company data (including logo), business-card snapshot, fiscal reminders.\n\nHow to delete\n\n- In the app: Settings → Data on this device → Delete all data on this device\n- Android: Settings → Apps → PerfectGest I → Storage → Clear data\n- Uninstall the app\n\nWarning: without an external copy, there is no recovery — we do not keep copies on our servers.\n\nShared backups: delete them manually where you saved them (WhatsApp, email, cloud)." },
    { heading: "2. Firebase / telemetry", body: "Anonymous installation metadata and usage metrics (subscription eligibility / anti-abuse; first business-card save). We do not host card content or logos on servers.\n\nEmail: suporte@perfectgestdev.com — Subject: Technical Data Deletion Request" },
    { heading: "3. Local notifications", body: "Cancelled when you uninstall or wipe app data." },
    { heading: "4. Timelines", body: "Local data: immediate. Firebase telemetry: up to 15 business days after an email request." }
  ],
  es: [
    { heading: "Introducción", body: "Última actualización: Julio de 2026\nPerfectGest I ofrece control claro de los datos conforme a Google Play y la LGPD. La app es local-first." },
    { heading: "Resumen", body: "Datos de clientes y financieros no se envían automáticamente a servidores PerfectGest. Solo salen del teléfono si usted comparte PDF, backups exportados, PNG/vCard de la tarjeta o muestra un QR con contactos profesionales." },
    { heading: "1. Datos de gestión (local)", body: "Almacenados en SQLite en el dispositivo: clientes, presupuestos comerciales, presupuestos fiscales y códigos fiscales, caja, órdenes de servicio, datos de empresa (incluido logotipo), copia de la tarjeta, recordatorios fiscales.\n\nCómo eliminar\n\n- En la app: Ajustes → Datos en este dispositivo → Eliminar todos los datos\n- Android: Ajustes → Aplicaciones → PerfectGest I → Almacenamiento → Borrar datos\n- Desinstalar la app\n\nAviso: sin copia externa, no hay recuperación — no guardamos copias en nuestros servidores.\n\nBackups compartidos: elimínelos manualmente donde los guardó." },
    { heading: "2. Firebase / telemetría", body: "Metadatos anónimos de instalación y métricas de uso (elegibilidad de suscripción / antiabuso; primer guardado de tarjeta). No alojamos contenido de la tarjeta ni el logotipo en servidores.\n\nCorreo: suporte@perfectgestdev.com — Asunto: Solicitud de Eliminación de Datos Técnicos" },
    { heading: "3. Notificaciones locales", body: "Se cancelan al desinstalar o borrar los datos de la app." },
    { heading: "4. Plazos", body: "Datos locales: inmediato. Telemetría Firebase: hasta 15 días hábiles tras la solicitud por correo." }
  ],
};
...
const faq = {
  pt: [
    ...
    { heading: "Posso usar a app sem assinatura?", body: "Sim, para explorar (navegar ecrãs e consultar a interface). Para operações (criar clientes, orçamentos comerciais ou fiscais, caixa; gerar PDFs de gestão; restauro de backup encriptado; e demais acções condicionadas) é necessário o Plano Pro. Ao tentar uma operação sem assinatura, surge um aviso com o plano (referência R$ 9,90/mês; preço na Google Play) e os botões Assinar ou Continuar a explorar recursos do Aplicativo." },
    { heading: "Como funciona o Plano Pro?", body: "Assinatura mensal ou anual na Google Play: clientes, orçamentos, caixa e PDFs sem limite prático; restauro de backup encriptado; cartão de visita interactivo (vCard, QR, preview). Gerir em Configurações → Assinatura Google Play." },
    ...
    { heading: "O que é a aba Orç/NF-e/NFS-e?", body: "Orçamento fiscal local (produtos e serviços, códigos NCM/CFOP/LC 116, PDF de apoio) e consulta/cadastro de códigos. Não emite NF-e nem NFS-e electrónica junto à SEFAZ/prefeitura." },
    ...
    { heading: "Os meus dados de clientes e financeiros estão protegidos?", body: "Sim. Clientes, orçamentos (comerciais e fiscais), caixa e valores ficam na base local. A app não envia esses dados para servidores.\n\nSó saem do telemóvel se você decidir:\n\n- Partilhar um PDF\n- Partilhar o cartão de visita (PNG, vCard ou QR — contactos profissionais)\n- Partilhar um backup exportado em Configurações (recomendamos backup encriptado no Plano Pro)" },
  ...
  en: [
    ...
    { heading: "Does it work offline?", body: "Offline-first for daily use. Optional Google services (Analytics, Remote Config, minimal Firestore for subscription eligibility) may need a network when active." },
    ...
    { heading: "How does the Pro Plan work?", body: "Monthly or annual subscription on Google Play: clients, estimates, cash and PDFs without practical limits; encrypted backup restore; interactive business card (vCard, QR, preview). Manage in Settings → Google Play subscription." },
    ...
    { heading: "What is the Quote/NF-e/NFS-e tab?", body: "A local fiscal quote (products and services, NCM/CFOP/LC 116 codes, support PDF) plus code lookup/registration. It does not issue electronic NF-e/NFS-e to tax authorities." },
    ...
    { heading: "Are my client and financial data protected?", body: "Yes. Stored locally (including fiscal quotes). They leave the device only if you share a PDF, card PNG/vCard/QR, or an exported backup file (encrypted backup recommended on Pro)." },
    { heading: "Fiscal reminders, weekly calendar, Latest entries, notifications, ads, Crashlytics, languages?", body: "On-device fiscal reminders (informational only); weekly calendar in Company; home shortcuts to recent records; local notifications only; no ads; no Crashlytics; PT / EN / ES." },
  ...
  es: [
    ...
    { heading: "¿Qué es PerfectGest I?", body: "App de gestión en el teléfono, con datos locales (SQLite). No hay «cuenta en la nube» PerfectGest para clientes, presupuestos o caja." },
    { heading: "¿Funciona sin internet?", body: "Sí, uso diario offline-first. Servicios Google opcionales (Analytics, Remote Config, Firestore mínimo de elegibilidad) pueden usar red cuando están activos." },
    ...
    { heading: "¿Cómo funciona el Plan Pro?", body: "Suscripción mensual o anual en Google Play: clientes, presupuestos, caja y PDF sin límite práctico; restauración de backup cifrado; tarjeta interactiva (vCard, QR, vista previa). Gestionar en Ajustes → Suscripción Google Play." },
    { heading: "¿Dónde gestiono la suscripción?", body: "Ajustes → Suscripción Google Play. Cancelación: Play Store → Pagos y suscripciones." },
    { heading: "¿Qué es la pestaña Presup./NF-e/NFS-e?", body: "Presupuesto fiscal local (productos y servicios, códigos NCM/CFOP/LC 116, PDF de apoyo) y consulta/registro de códigos. No emite NF-e ni NFS-e electrónica ante la autoridad fiscal." },
    ...
    { heading: "¿Están protegidos mis datos de clientes y financieros?", body: "Sí. Solo salen si usted comparte PDF, PNG/vCard/QR de la tarjeta o backup exportado (cifrado recomendado en Pro). Incluye presupuestos fiscales locales." },
    { heading: "Recordatorios fiscales, calendario, últimos registros, notificaciones, anuncios, Crashlytics, idiomas?", body: "Recordatorios locales informativos; calendario semanal en Empresa; atajos en inicio; solo notificaciones locales; sin anuncios; sin Crashlytics; PT / EN / ES." },
    { heading: "Privacidad, eliminación, sugerencias?", body: "Ajustes → Ayuda y soporte para enlaces legales. Borrar datos: Ajustes → Datos en este dispositivo. Sugerencias: pestaña Empresa → suporte@perfectgestdev.com." }
  ],
};
