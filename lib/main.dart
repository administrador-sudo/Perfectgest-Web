...
class _HeroContabilIntro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        gold3d(l10n.heroContabilTitle, titleStyle),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilMei2027, subtitleStyle),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilLead, bodyStyle, compact: true),
        const SizedBox(height: 14),
        gold3d(l10n.heroContabilWhyNowTitle, subtitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilWhyNowBody, bodyStyle, compact: true),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilBulletPix, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilBulletLimit, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilBulletMandatory, bodyStyle, compact: true),
        const SizedBox(height: 14),
        gold3d(l10n.heroContabilFeaturesTitle, subtitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilFeaturesLead, bodyStyle, compact: true),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilFeatEmit, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilFeatThermometer, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilFeatRadar, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilFeatCashbook, bodyStyle, compact: true),
        const SizedBox(height: 18),
        gold3d(l10n.heroContabilMoreThanApp, largeTitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilPartnerOffice, subtitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilHumanSupport, bodyStyle, compact: true),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilBulletSupport, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilBulletGrowth, bodyStyle, compact: true),
        const SizedBox(height: 18),
        gold3d(l10n.heroContabilNoRisk, largeTitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilStartToday, subtitleStyle),
        const SizedBox(height: 8),
        gold3d(l10n.heroContabilAndroid, bodyStyle, compact: true),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilLgpd, bodyStyle, compact: true),
        const SizedBox(height: 18),
        gold3d(l10n.heroContabilPlansIntro, plansIntroStyle),
        const SizedBox(height: 10),
        gold3d(l10n.heroContabilPlanBasicTitle, subtitleStyle),
        const SizedBox(height: 6),
        gold3d(l10n.heroContabilPlanBasicBody, bodyStyle, compact: true),
        const SizedBox(height: 12),
